...
def stamps2kite(
    ...
    config.meta.time_primary = data.tmin.timestamp()
    config.meta.time_secondary = data.tmax.timestamp()
...
The data has to be fully processed through StaMPS and may stem from the primary
